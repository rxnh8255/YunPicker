...
*/
ChinaPicker.prototype.getPictures = function(success, fail, options) {
	if (!options) {
		options = {};
	}
	...
	return cordova.exec(success, fail, "ChinaPicker", "getPictures", [params]);
};

window.chinaPicker = new ChinaPicker();
